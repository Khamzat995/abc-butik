...
const BlogDetailsStandardOne = lazy(() => import("./pages/blog/BlogDetailsStandardOne"));
const BlogDetailsStandardTwo = lazy(() => import("./pages/blog/BlogDetailsStandardTwo"));
const BlogDetailsStandardThree = lazy(() => import("./pages/blog/BlogDetailsStandardThree"));
const BlogDetailsStandardFour = lazy(() => import("./pages/blog/BlogDetailsStandardFour"));
const BlogDetailsStandardFive = lazy(() => import("./pages/blog/BlogDetailsStandardFive"));
const BlogDetailsStandardSix = lazy(() => import("./pages/blog/BlogDetailsStandardSix"));
