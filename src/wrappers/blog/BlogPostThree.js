    ...
    <Fragment>
      <div className="blog-details-top">
        <div className="blog-details-img">
          <img
            alt=""
            src={process.env.PUBLIC_URL + "/assets/img/blog/izobrazhenie-33.webp"}
          />
        </div>
        <div className="blog-details-content">
          ...
          <h3>BRUNELLO CUCINELLI ВЕСНА-ЛЕТО 2022</h3>
          <p>
      ...
      <div className="dec-img-wrapper">
        <div className="row">
          ...
          <div className="col-md-6">
            <div className="dec-img mb-50">
              <a href="https://istanbul-expert.com/products/62cc298a8e57e02670780f8d">
                <video autoPlay={true} loop={true} playsInline={true} muted >
                  <source src={process.env.PUBLIC_URL + "/assets/video/3_Yamanevler.mp4"} type="video/mp4" />
                </video>
